...
Sub Delivery()
	...
	Wend
	wait 1
	JavaWindow("Ejecutivo de interacción").CaptureBitmap RutaEvidencias() & "direccionenvio.png", True
	imagenToWord "Negociar dirección de envio",RutaEvidencias() & "direccionenvio.png"
	...
	End If
		...
		wait 2
		JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Negociar dirección de").JavaEdit("Número de teléfono del").Set "970706539"
		wait 2
		Set shell = CreateObject("Wscript.Shell") 
		shell.SendKeys "{PGDN}"
		JavaWindow("Ejecutivo de interacción").CaptureBitmap RutaEvidencias() &Num_Iter&"_"&"SelecContacto.png", True
		imagenToWord "Negociar Dirección terminado",RutaEvidencias() &Num_Iter&"_"&"SelecContacto.png"
		wait 2
...
Sub NegociarPago()
	...
	End If
	While JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Pago Inmediato").JavaButton("Enviar").Exist = false
		wait 1
	Wend
	wait 2
	Dim Val
